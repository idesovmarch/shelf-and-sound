...
declare global { interface Window { libraryAPI?: { read: () => Promise<LibraryData>; write: (data: LibraryData) => Promise<LibraryData>; searchBooks: (query: string, page: number, size: number) => Promise<any>; searchMusic: (query: string, page: number, size: number) => Promise<any>; openExternal: (url: string) => Promise<void> } } }
